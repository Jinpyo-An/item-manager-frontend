	...
	<div class="home-page">
		...
		<section class="user-products-section">
			...
			<div class="section-header">
				<h2>나의 전자 제품</h2>
				<button class="view-more-button" @click="goToUserProducts">
					View more<i class="view-more-icon"
		...
		<section class="product-section">
			<div class="section-header">
				<h2>더 알아볼까요?</h2>
				<button class="view-more-button" @click="goToProducts">
					View more<i class="view-more-icon"
						><font-awesome-icon :icon="['fas', 'greater-than']"
					/></i>
				</button>
